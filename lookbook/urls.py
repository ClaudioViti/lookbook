...
from shoes.views import ShoeListView, CartUpdateView, FavouriteUpdateView, OrderedUpdateView, minicartView, favouriteView, get_current_brand, create_shoe, edit_shoe, ShoeDeleteView, image_view, order_list, contact, UrgentUpdateView, BrandCreate, BrandUpdate, BrandDelete, BrandManage, ShoeListManage, ordersView, terminate_order, terminateOrder, LoginViewCustom, ConfigView
...
urlpatterns = [
    ...
    path('getcurrentbrand/', get_current_brand, name="getcurrentbrand"),
